...
(function($) {
	$.fn.fancyzoom = function(userOptions) {
		...
		function openZoomBox(imgSrc,o){
            ...
            var $fctEnd = function(){
            	...
            	if($.fn.shadow && o.shadow &&true){ $('img:first',oImgZoomBox).shadow(o.shadowOpts);}
				if(o.Speed>0 && true) {o.oImgClose.fadeIn('slow');$('div',oImgZoomBox).fadeIn('slow');}
   		...
   		return this.each(function() {
	    	...
	    	oOverlay.css({
   			...
   			$this.click(function(){
                ...
                var oImgZoomBox = $('<div class="jqfancyzoombox" style="z-index£º9999;position:absolute"></div>').css(o.oImgZoomBoxProp);
	...
	function __displayLoading(o){
		...
		oLoading.css(__posCenter(50,50)).html('<img src="'+o.imgDir+'blank.gif"/*tpa=http://218.77.42.151:8913/js/'+o.imgDir+'blank.gif*/ />').click(function(){__cancelLoading();}).appendTo('body').show();
